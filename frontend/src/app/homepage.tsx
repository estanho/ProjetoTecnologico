  ...
  return (
    <div className="m-4">
      <div className="flex flex-col items-center justify-center mt-32">
        <div className="max-w-screen-md w-full items-center">
              ...
              <Card>
                <CardBody className="bg-gray-100">
                  <div className="text-justify">
                    ...
                    <p className="m-2">
                      • A plataforma suporta apenas uma escola por turno (manhã,
                      tarde e noite). O sistema tenta gerar rotas considerando
                      ida e volta, mesclando embarques e desembarques quando
                      necessário.
                    </p>
                    <p className="m-2">
                    ...
                    <p className="m-6 text-center font-semibold">
                      ⚠️ Os dados apresentados nas imagens dos perfis são todos
                      fictícios! ⚠️
                    </p>
              ...
              <Card>
                <CardBody className="bg-gray-100">
                  <div className="text-justify">
                    ...
                    <p className="m-2">
                      • Na Lista de alunos é possível visualizar as informações
                      detalhadas dos alunos e um botão para abrir diretamente o
                      aplicativo WhatsApp do responsável registrado.
                    </p>
                    <p className="m-2">
                    ...
                    <p className="mb-2">
                      ...
                      oferece uma visão detalhada das viagens realizadas no dia.
                    </p>
                    <p>
              ...
              <Card>
                <CardBody className="bg-gray-100">
                  <div className="text-justify">
                    ...
                    <p className="mb-4">
                      • O perfil de estudantes proporciona acesso a notificações
                      de embarque e desembarque, além de um histórico detalhado
                      das viagens. Quando o estudante está em uma viagem ativa,
                      é possível visualizar a posição da van escolar em tempo
                      real por meio do mapa interativo.
                    </p>
                    <h1 className="mt-8 text-lg font-bold mb-8 text-center">
                      Imagens
                    </h1>
            ...
            <Tab key="responsible" title="Responsável">
              <Card>
                <CardBody className="bg-gray-100">
                  <div className="text-justify">
                    <p className="mb-4">
                      Assim como o estudante, o <strong>responsável</strong> tem
                      acesso a notificações e ao roteiro com a localização do
                      motorista.
                    </p>
                    <p className="mb-4">
                      • O cadastro do responsável é facilitado pelo motorista na
                      tela de estudantes, onde o e-mail é registrado. O
                      responsável pode se cadastrar usando o mesmo e-mail,
                      permitindo acesso às informações do aluno. É possível ter
                      mais de um responsável cadastrado por estudante.
                    </p>
                    <h1 className="mt-8 text-lg font-bold mb-8 text-center">
                      Imagens
                    </h1>
